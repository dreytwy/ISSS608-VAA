...
ggplot(exam,
  ...
  geom_density_ridges(
    ...
    rel_min_height = 0.01,
    bandwidth = 2.5,
    fill = lighten("aquamarine2", .6), 
    color = "#7097BB") + # border color
  scale_x_continuous(
    name = "English grades",
    expand = c(0,0),
  ) +
...
#### **4.4.4.1** Distribution of English Scores Across Races
...
#### **4.4.4.2** Distribution of English Scores Across Classes
