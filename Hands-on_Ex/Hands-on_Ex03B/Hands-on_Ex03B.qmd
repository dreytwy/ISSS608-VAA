...
When telling a visually-driven data story, animated graphics tends to attract the interest of the audience and make deeper impression than static graphics. This exercise will focus on:
...
```{r, echo=FALSE}
library(magick)
img <- image_read("https://r4va.netlify.app/chap04/img/image1.jpg")
plot(img)
```
...
## **3.3.3 Building multiple animated subplots**

We can also create multiple animated bubble subplots of Continent.

In the code chunk below,

-   facet_wrap is used on Continent.
