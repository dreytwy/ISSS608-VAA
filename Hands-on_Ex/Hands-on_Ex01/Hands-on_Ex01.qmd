...
**ggplot2** ![](https://r4va.netlify.app/chap01/img/image1.jpg){width="30"} is an R package for **declaratively** creating **data-driven** graphics based on ***The Grammar of Graphics.***

```{r, echo=FALSE}
img <- image_read("https://r4va.netlify.app/chap01/img/image5.png")
plot(img)
```
...
```{r, echo=FALSE}
img <- image_read("https://r4va.netlify.app/chap01/img/image2.png")
plot(img)
```
