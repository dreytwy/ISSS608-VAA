...
-   The scatterplot visualizes the relationship between two subjects.
...
## Science vs English: Code & Plot

```{r}
# Save the scatter plot in a variable
p <- ggplot(exam_data, aes(x =SCIENCE, 
                           y =ENGLISH))+
  geom_point(color = "navyblue")+ 
  labs(title = "Science vs English Scores")
...
-   Skewness: Slighly negatively skewed distribution (longer left tail) for Math and Science. Slightly positively skewed distribution (longer right tail) for English.

-   Data concentration: Math \[50-75 range\], Science \[75-100\], English \[60-80\]. Few students at both the ends of higher and lower scores.
