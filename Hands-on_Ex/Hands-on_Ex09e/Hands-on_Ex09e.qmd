---
title: "9e. Treemap Visualisation with R"
author: "Audrey Tan"
date: "13 June 2025"
...
Before we get started, we are required to check if **treemap** and **tidyverse** pacakges have been installed in we R.
...
1.  If this is the first time we install a package from github, we should install *devtools* package by using the code below or else we can skip this step.
